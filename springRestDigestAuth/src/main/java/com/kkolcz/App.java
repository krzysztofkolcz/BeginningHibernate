...
public class App {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        credsProvider.setCredentials(new AuthScope(targetHost.getHostName(), targetHost.getPort()), new UsernamePasswordCredentials("devapi", "devApiPass"));
        ...
        try {
            ...
            final HttpGet httpget = new HttpGet("http://localhost:8080/panel/api/ifi/sprawdz-domene/email/info@testing0320.pl/domena/testing0320.pl/abonentId/451266.json");
